...
{
    public class GetAllRefillingRequestModel
    {
        public string REF_Number { get; set; }
        //public string Retrieval_Type { get; set; }
        //public string Retrieval_region { get; set; }
    ...
    public class GetAllRefillingAllModel
    {
        public string REF_Number { get; set; } 
        public string File_Status { get; set; }
        public string Ref1 { get; set; }
        ...
        public DateTime? Refilling_Date { get; set; }

        public string RefillingBy { get; set; }
